<template>
  <div class="work-type-conent-coll-c">
                ...
                <p
                  :class="
                    addWorkIdList.indexOf(item.questionId) == -1
                      ...
                      : 'hover-p2'
                  "
                  @click="addWork_(item.questionId)"
                >
  ...
  methods: {
    ...
    addWork_(id) {
      if (this.addWorkIdList.includes(id)) {
        this.addWorkIdList = this.addWorkIdList.filter(item => {
          return item !== id
        })
        // for (var i = 0; i < this.addWorkIdList.length; i++) {
        //   if (this.addWorkIdList[i] === id) {
        //     var arr = [0, 1, 2].splice(0, 1)
        //     console.log(arr)
    ...
    getGroupQuestions(id, page, list) {
      //this.collectonQuestionsList = []
      this.currentinfo = {
        page: page,
        id: id
