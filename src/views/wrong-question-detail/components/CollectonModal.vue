...
export default {
  ...
  methods: {
    ...
    addStores() {
      this.$store
        .dispatch('publish/addStore', {
          collectonGroupId: this.addGroupId,
          grade: this.item.sectionSubjectQuestionInfo.grade,
          questionId: this.item.sectionSubjectQuestionInfo.questionId,
          questionInfoId: this.item.sectionSubjectQuestionInfo.questionInfoId,
          questionSourceId: this.item.sectionSubjectQuestionInfo
            .questionSourceId,
          questionSourceName: this.item.sectionSubjectQuestionInfo
            .questionSourceName,
          questionUuid: this.item.sectionSubjectQuestionInfo.questionUuid,
