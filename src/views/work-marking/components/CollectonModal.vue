    ...
    addStores() {
      this.$store
        .dispatch('publish/addStore', {
          ...
          questionInfoId: this.questionInfo.questionInfoId,
          questionSourceId: this.questionInfo.questionSourceId,
          questionSourceName: this.questionInfo.questionSourceName,
          questionUuid: this.questionInfo.questionUuid,
          questionTypeCode: this.questionInfo.questionTypeCode
        })
        .then(data => {
          this.$emit('onHideCollect')
          if (data.flag === 1) {
