    ...
    <div class="content">
        ...
        <div>
          ...
          <span class="sort">
            <i
              class="sort-caret ascending"
              :class="
                sortColumn === 'averageScore' && sortRule === 'Asc'
                  ? 'active'
                  : ''
              "
              @click="handleSort('averageScore', 'Asc')"
            ></i>
            <i
              class="sort-caret descending"
              :class="
                sortColumn === 'averageScore' && sortRule === 'Desc'
                  ? 'active'
                  : ''
              "
              @click="handleSort('averageScore', 'Desc')"
            ></i>
          </span>
        </div>
        <div>
      ...
      <ul class="list">
        ...
        >
          ...
          <div>{{ student.homeworkAnswerscore || '--' }}</div>
